				    ...
				    $obj->str_word_count1($text2);
					    ...
					    $obj->substr1($text);
						 ...
						 $array = array(1,2,3,4,5,6,7);
						  ...
						  $games = array("d" => "cricket", "a" => "tennis", "b" => "badminton", "c" =>
						  "football");
																																											...
																																											($text);
																																												   ...
																																												   '<hr>';
																																															      ...
																																															      str_word_count1($text2)
																																															      {
																																																    ...
																																																    Function
																																																    Demo</h1>';
																																																        print_r(str_word_count($text2,
																																																	1));

																																																	    echo
																																																	    str_word_count($text2);
																																																	               echo
																																																		       '<hr>';
